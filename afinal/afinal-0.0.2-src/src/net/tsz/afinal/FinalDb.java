...
public class FinalDb {
	...
	public static FinalDb creat(Context context){
	...
	public static FinalDb creat(Context context,boolean isDebug){
		DaoConfig config = new DaoConfig();
		config.setContext(context);
	...
	public static FinalDb creat(Context context,String dbName){
		DaoConfig config = new DaoConfig();
		config.setContext(context);
	...
	public static FinalDb creat(Context context,String dbName,boolean isDebug){
		DaoConfig config = new DaoConfig();
		config.setContext(context);
		config.setDbName(dbName);
		config.setDebug(isDebug);
	...
	public static FinalDb creatSqliteDao(DaoConfig daoConfig){
